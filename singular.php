<?php
/**
 * The template for displaying Default Singular Page
 *
 * @package WordPress
...
<section class="padding-top--100 padding-bottom--100">
	<div class="wrapper--80">
		...
		<p class="font-family--font-lora text-center paragraph--18 font-weight--300 font-color--text-color letter-space--27 all-caps"><?php _e( $overview_small_heading, "Kings Pavilion" ); ?></p>
		<?php } ?>
		...
		<div class="wysiwig-container font-family--font-lora paragraph--20 font-weight--300 font-color--black letter-space--1"><?php _e( $overview_text, "Kings Pavilion" ); ?></div>
		<?php } ?>
	</div>
</section>
<?php

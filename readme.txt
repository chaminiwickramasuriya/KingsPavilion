...
https://wordpress.org/support/article/emebaseedu-changelog/#Version_1.2

= 1.1 =
* Released: December 12, 2019

https://wordpress.org/support/article/emebaseedu-changelog/#Version_1.1
...
Pure WP Base WordPress Theme, Copyright 2019-2020 WordPress.org
Pure WP Base is distributed under the terms of the GNU GPL.
...
Pure WP Base is derived from the Chaplin Theme, Copyright 2019 Anders Norén
Chaplin Theme is distributed under the terms of the GNU GPL version 2.0

Pure WP Base bundles the following third-party resources:
...
Bespoke Icons Created For Pure WP Base
License: Creative Commons Zero (CC0), https://creativecommons.org/publicdomain/zero/1.0/
...
- EMEBASEEdu_SVG_Icons
- emebaseedu_the_theme_svg()
- emebaseedu_get_theme_svg()
- emebaseedu_nav_menu_social_icons()

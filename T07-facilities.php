    ...
    <div class="wrapper--80">
        ...
        <div class="sidebysideBlock d-flex justify-content-between align-items-center padding-bottom--100 protab-flex-column mobile-flex-column">
            ...
            <div class="half-div--46 descriptionBlock">
                <div class="blocktext heading--32 font-family--dmserif font-color--main-color padding-bottom--30 mobile-text-center"><?php _e($side_block_title, "KingsPavilion");?></div>
                <div class="descriptiontext paragraph--20 font-family--opensans font-color--text-color padding-bottom--30 mobile-text-center"><?php _e($side_block_description, "KingsPavilion");?></div>
                <?php
                if (in_array('link', $select_data_text)):
                ?>
                    <a class="moredetails font-color--text-color font-weight--400 m-auto" href="<?php echo esc_url($sideblock_link_url); ?>" title="<?php _e($link_url_text, "KingsPavilion");?>">
                ...
                ?>
                    <?php if($side_block_sub_text){?> 
                        <p class="subtext font-color--btn-color font-family--opensans title-case paragraph--16 padding-bottom--15 mobile-text-center">
                            <?php _e($side_block_sub_text, "KingsPavilion");?>
                        </p>
                    <?php }?>
                    <p class="dataText heading--32 font-family--dmserif font-color--btn-color mobile-text-center">
                        <?php _e($data_text_name, "KingsPavilion");?>
                    </p>
                <? endif;
                if (in_array('pdf', $select_data_text)):
                ?>
                    <a class="downloadBtn m-0 mobile-margin-auto" href="<?php echo esc_url($brochure_download_pdf_link);?>" title="<?php _e($download_pdf_text_expo, "KingsPavilion");?>">
